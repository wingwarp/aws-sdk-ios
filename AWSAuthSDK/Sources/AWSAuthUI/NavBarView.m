...
//    [labelView.trailingAnchor constraintEqualToAnchor:self.trailingAnchor].active = YES;
    ...
    [labelView.centerYAnchor constraintEqualToAnchor:self.centerYAnchor].active = YES;
    [labelView.heightAnchor constraintEqualToAnchor:self.heightAnchor].active = YES;
}
